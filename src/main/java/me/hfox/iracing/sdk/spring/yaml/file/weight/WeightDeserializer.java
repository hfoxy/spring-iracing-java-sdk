...
public class WeightDeserializer extends JsonDeserializer<Weight> {
    ...
    @Override
    public Weight deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JacksonException {
        ...
        WeightUnit type = WeightUnit.findByShorthand(unitValue).orElseThrow(() -> new SdkJsonProcessingException("unknown unit: " + unitValue, p.getCurrentLocation()));

        return new Weight(value, type);
    }
